...
monitoring_api = Blueprint('monitoring_api_v2', __name__, url_prefix='/v2/monitoring-service')
...
@monitoring_api.route('/content', methods=['POST'])
def create_content():
...
@monitoring_api.route('/contents', methods=['GET'])
def get_contents():
...
@monitoring_api.route('/content/<int:id>', methods=['GET'])
def get_content(id):
...
@monitoring_api.route('/content/<int:id>', methods=['PUT'])
...
@monitoring_api.route('/content/<int:id>', methods=['DELETE'])
